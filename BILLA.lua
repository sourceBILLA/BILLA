...
if text == "بوت" then
tdcli_function ({ID = "GetUser",user_id_ = SUDO},function(arg,s) 
tdcli_function ({ID = "GetUser",user_id_ = bot_id},function(arg,b) 
local Namebot = (bot_data:get(bot_id..'Name:Bot') or 'بيلا') 
local YYYBD_Msg = { 
...
Namebot = YYYBD_Msg[math.random(#YYYBD_Msg)] 
local msg_id = msg.id_/2097152/0.5  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = ' مــطــور الــبــوت🔰', url="http://t.me/"..s.UserName},
},
{
{text = 'اضغط لاضافه البوت لمجمعتك✅ ' ,url="t.me/"..b.UserName.."?startgroup=start"},
},
}
...
local YYYBD = 'https://t.me/Qtdao/71'
keyboard = {} 
keyboard.inline_keyboard = {{{text = textt, url="http://t.me/"..username}},}
local function getpro(extra, result, success) 
if result.photos_[0] then 
...
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=' .. URL.escape(YYYBD).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end end 
...
send(msg.chat_id_, msg.id_, t..'ٴ➫✿∫ٴ*•━━━━━━ 𝑩A ━━━━━━━•*ٴ➫✿∫○ٴ\n➫✿︙[⍆ BiLla 𝘛𝘦𝘈𝘮](t.me/EE28i) ')
end
