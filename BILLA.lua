...
if text == '@SSSSSSYBOT' or text == 'مبرمج السورس' or text == 'مطور سورس' then
Text = [[
≪━━━━━━𝑩𝑰━━━━━━≫
...
send(msg.chat_id_, msg.id_,"*⌯︙لا تستطيع (كتم،طرد،حظر،تققيد) @SSSSSSYBOT او الاساسي*")
return false 
end
...
function start_function(extra, result, success)
if BILLASudoBot(result.sender_user_id_) then
send(msg.chat_id_, msg.id_," *⌯︙لا تستطيع تنزيل @SSSSSSYBOT او الاساسي*")
return false 
end
