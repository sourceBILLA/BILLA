...
if text == 'تنزيل خمار' and Mod(msg) then
database:del(bot_id..'Zahf:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' *➫✿︙تم تنزيل جميع خمار*')
end هههههههه
else
if text == ("تاك للخمارين") and Mod(msg) then
local list = database:smembers(bot_id..'Zahf:User'..msg.chat_id_)
t = "\n *➫✿︙قائمة الخمارين الكروب* \n*•━━━━━━ 𝑩𝑰 ━━━━━━━•*\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."» *الخمارين* [@"..username.."]\n"
else
t = t..""..k.."» *الخمارين* "..v.."\n"
end
end
...
if text == ("رفع خمار") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
'هاا شتريد كافي ☹️.',
'شتريد من تاج راسك/خ.',
'تره والله دايخ وراسي يئذيني احجي وفضني.', 'شتريد من سيادتك😂.',
'مشايف بوت شني 😂.',
'لحد يكرهني تره احبكم والله جاي اشاقه🥺.',
'حبي يمي امي ما تخليني احجي وياك😂.',
'حياتي خلي يروح ابوي واحجي وياج😂.',
...
[[
「 #rdphoto 」
مـٰعــُڒٍفڪ 「 #username 」
آيدِيڪ 「 #id 」
صــــًﻭڒٍڪ 「 #photos 」
ڒٍتـٰཻــبـتـٰཻــڪ 「 #stast 」
ســحــ۫ـڪآتـٰཻــڪ 「 #edit 」
ڒٍســآئلـڪ 「 #msgs 」
تـٰཻــفآعــُلـڪ 「 #auto 」
]]‚
[[
🇫🇷• 𝐘𝐎𝐔𝐑 𝐈𝐃 𖠰 #id .
🇫🇷• 𝐌𝐒𝐆𝐒 𖠰 #msgs .
...
" ➫✿︙اريد امص شفايفك/ج😋🤤 "‚
" ➫✿︙صوره زربه😂 "‚
" ➫✿︙شهل جمال كله تعال ابوسك من خدك😂🤤 "‚
}
...
{{text = 'م⓸', callback_data="/help4"},{text = 'م⓹', callback_data="/help5"}},
{{text = 'م⓺', callback_data="/help6"},{text = 'م⓻', callback_data="/help7"},{text = 'م⓼', callback_data="/help8"}},
{{text = 'م⓽', callback_data="/help9"},{text = 'م⓵⓪', callback_data="/help10"}},
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'م⓵', callback_data="/help1"},{text = 'م⓶', callback_data="/help2"},{text = '⓷', callback_data="/help3"}},
{{text = 'م⓸', callback_data="/help4"},{text = 'م⓹', callback_data="/help5"}},
{{text = 'م⓺', callback_data="/help6"},{text = 'م⓻', callback_data="/help7"},{text = '⓼', callback_data="/help8"}},
{{text = 'م⓽', callback_data="/help9"},{text = 'م⓵⓪', callback_data="/help10"}},
{{text = 'الاوامر الرئيسيه', callback_data="/help"}},
{{text = '⍆ BiLla 𝘛𝘦𝘈𝘮', url="t.me/EE92i"}},
}
